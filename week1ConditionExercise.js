...
function exercise1(num1) {
  ...
  function exercise4(varA, varB) {
    ...
    if (varA === varB){
        ...
        answer4 = varA + " and " + varB + " is not equal."
    }
    // --------------------------------------------
    // And above here
    // --------------------------------------------
  ...
  console.log(exercise4(11,11));
  console.log(exercise4(11,15));
  // EXERCISE 5.
  ...
  //The unexpected case will be when in the condition statement the value of varA is a string variable 1 and varB is the numeric 1 with "===" as a operator, 
 // the statement  will not pass the test because the system considers they are different. 
  ...
  console.log(exercise6(11,11,43));
  console.log(exercise6(11,11,11));
  // EXERCISE 8.
  ...
  function exercise8(amount1, amount2, minimum, maximum) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if (minimum <amount1 && amount2 < maximum ) {
      answer8 = true;
    }else {
    answer8 = false;
    }
  ...
  console.log(exercise8(1,2,0,10));
  console.log(exercise8(1,2,3,10));
  // EXERCISE 9.
  ...
  //It is  not too hard. Some of the problems I used W3School examples as references.
