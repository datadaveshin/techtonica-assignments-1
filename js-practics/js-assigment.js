...
//Practices for JS4
       // Activity 1
       let desiredVacation = [ ['Tammy', 'Tahiti'], ['Erin', 'Banff, Alberta, Canada'], ['Janet', 'London'] ];
       function printVacations(array){
        for (let i=0; i<desiredVacation.length; i++){
            console.log(array[i][0]+ " is willing to go to "+ array[i][1]);
        }
    }
    console.log(printVacations(desiredVacation));

//JS 5
    //Practice on Conditional Statement
    ...
    console.log(getLetter("abd"))
    
        console.log(getLetter("bcd"));
